...
type AccountServiceClient interface {
	...
	List(ctx context.Context, in *ListAccountResponse, opts ...grpc.CallOption) (*ListAccountResponse, error)
...
func (c *accountServiceClient) List(ctx context.Context, in *ListAccountResponse, opts ...grpc.CallOption) (*ListAccountResponse, error) {
...
type AccountServiceServer interface {
	...
	List(context.Context, *ListAccountResponse) (*ListAccountResponse, error)
...
func (UnimplementedAccountServiceServer) List(context.Context, *ListAccountResponse) (*ListAccountResponse, error) {
...
func _AccountService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).List(ctx, req.(*ListAccountResponse))
	}
	return interceptor(ctx, in, info, handler)
}
